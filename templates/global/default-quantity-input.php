...
if ( $args['max_value'] && $args['min_value'] === $args['max_value'] ) {
	?>
	<div class="quantity hidden <?php echo esc_attr( ! empty( $args['main_class'] ) ? $args['main_class'] : '' ); ?>">
	...
	?>
	<div class="quantity <?php echo esc_attr( ( ! empty( $args['main_class'] ) ? $args['main_class'] : '' ) ); ?>">
